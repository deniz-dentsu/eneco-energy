...
// 1. INCREASE THE DRAIN (makes it empty faster) // Change the 5 to a higher number, like 8 or 10. let drain = 5 * delta;

let gain = 0;

// 2. REQUIRE MORE ACTIVITY TO TRIGGER GAIN // Change the 10s to 20 or 30 so minor movements don't count. if (currentMotionLevel > 10 || currentAudioLevel > 10) {
